...
(RN-02: só `Pendente` é cancelável no MVP; ver DEC-09, respondida em 24/09/2026 (o C# aceita cancelar Quitada com motivo; o Vendas mantém o bloqueio local, Seção 3)).
...
**Relação direta com DEC-08/DEC-09 (histórico da proposta de 22/09; respondidas em 24/09/2026, ver Seção 3):**
