...
- Status: **Aberto (adiado)** — retomar no fim do projeto, com todas as tarefas prontas, antes do encerramento/deploy. Atualização 2026-09-24: o item M5 (falha de `Enfileirar` do e-mail engolida) foi coberto pela RF12-01 e parte do M3 pela RF13-02 (pós-quitação no reenvio); M1 (mensagem da UI quando o Financeiro quitou e a gravação local falhou), M2, M4 e M6 continuam abertos.
